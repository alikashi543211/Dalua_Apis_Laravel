        ...
        'default' => [
            ...
            'connection_settings' => [
                ...
                'tls' => [
                    ...
                    'ca_file' => env('MQTT_CERT_FILE', ''),
                    'ca_path' => env('MQTT_CERT_FILE_PATH', ''),
                    'client_certificate_file' => env('MQTT_LOCAL_CERT', ''),
                    'client_certificate_key_file' => env('MQTT_LOCAL_PK', ''),
                    'client_certificate_key_passphrase' => env('MQTT_LOCAL_PK_PASSPHRASE', ''),
                ],
